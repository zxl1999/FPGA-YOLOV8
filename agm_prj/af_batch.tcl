...
set bc_config [file join . bc_config.txt]
...
set result_dir [file join $results $id]
...
print "***************************************************************************\n" >> $summary
print "$title\n" >> $summary
cat [file join $result_dir alta_db fmax.rpt] >> $summary
cat [file join $result_dir alta_db xfer.rpt] >> $summary
print "" >> $summary
}
